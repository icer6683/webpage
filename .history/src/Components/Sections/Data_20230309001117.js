...
export const homeObjOne = {
    ...
    description: "I'm from Connecticut and I'm looking to pursue a finance concentration along with a dual degree in computer science at Wharton. I'm interested in the intersection of technology and high finance. \n\nIn my free time, you'll find me jamming to music, experimenting in the kitchen or learning new things. Nice to meet you!",
    shape: false,
    imgStart: true,
    img: face,
    alt: 'Face',
...
export const homeObjTwo = {
    ...
    topLine: 'Updates',
    headline: "Current",
    description: "At Wharton, I am primarily involved with the Wharton Asian Exchange, Penn Wharton China Summit and Wharton Undegraduate Distressed Investing Group. ",
    shape: false,
    imgStart: false,
    img: walking,
